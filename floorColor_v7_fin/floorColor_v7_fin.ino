//zero. 2017/10/21 V6.. 2017/10/30 v7 .. 1.ON led, 2. wait 9s,3.off led view by znh    //
// ======================================================================== //
//  Pin setup:                                                              //
//                                                                          //
// -------                                                                  //
...
void loop() {
  ...
  for (int iNum = 0;  iNum < total; iNum += 3) { //0-14 or 0-11
    bigSmall = rgbBiggest(COLORS[next] );
    finish = setColor(COLORS[next], bigSmall[0], iNum, now, rise); // set 1.COLORS && 2.bigValue = [0] && 3.now floor && 4.pca 5. rise or down
...
int* rgbBiggest(int* rgb ) {  // choice bigest Value
